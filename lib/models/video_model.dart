...
class VideoProvider with ChangeNotifier {
  ...
  Future<void> getVideo(String requestKeyword) async {
    final keyword = 'music ' + requestKeyword; //DIMANA KEYWORDNYA MENGGUNAKAN PREFIX USTADZ SEHINGGA HANYA AKAN MENGAMBIL DATA YANG TERKAIT DENGAN USTADZ
    final apiToken = 'AIzaSyCAg22WTe0uuWVN9SysAjKvG1_Pm2DAfDI'; //MASUKKAN API TOKEN YANG KAMU DAPATKAN DARI PROSES SEBELUMNYA
